...
import static ru.yuriyshevtsov.vrntube.model.Camera.CAMERAS;
...
/**
 * A list fragment representing a list of Cameras. This fragment
 * also supports tablet devices by allowing list items to be given an
 * 'activated' state upon selection. This helps indicate which item is
 * currently being viewed in a {@link CameraDetailFragment}.
 * <p>
...
public class CameraListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<Object>(
                ...
                android.R.id.text1,
                (List<Object>) (List) Camera.CAMERAS) {
            @Override
            public Object getItem(int position) {
                return ((Camera) super.getItem(position)).address;
            }
        });
    }
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(CAMERAS.get(position).id);
    }
